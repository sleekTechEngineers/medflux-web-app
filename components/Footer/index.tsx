...
>
  <div className="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row">
    ...
    <div data-aos="fade-left"
      ...
      >
        Get your meds quickly and <br /> easily with Sleek.
      </h2>

      <p
        className="mt-4 text-gray-100 dark:text-black"
        style={{ marginLeft: "50px" }}
      >
    ...
    <Link href="">
      <button className="flex w-[140px] md:w-[200px] h-[40px] py-2 bg-black/45 items-center justify-center text-white font-medium hover:ring-2 hover:ring-indigo-600 hover:bg-black rounded-full hover:border-2 space-x-1.5 md:space-x-3">
        <Image
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                In summary, modern pharmacy systems redefine healthcare by combining efficiency, accessibility, and personalization to meet the diverse needs of patients and providers alike.
                </p>
...
<div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
  <div className="mb-12 lg:mb-16">
    ...
    <ul>
      ...
      <span className="font-normal text-black dark:text-white">© Copyright</span>
      </div>
        </div>
