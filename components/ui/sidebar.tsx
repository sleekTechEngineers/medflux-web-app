  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[state=collapsed][data-side=left]:cursor-e-resize group-data-[state=collapsed][data-side=right]:cursor-w-resize",
        "hover:group-data-[collapsible=offcanvas]:bg-sidebar group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full",
        "group-data-[collapsible=offcanvas][data-side=left]:-right-2",
        "group-data-[collapsible=offcanvas][data-side=right]:-left-2",
        className
      )}
      {...props}
    />
