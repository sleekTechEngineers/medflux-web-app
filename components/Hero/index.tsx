  ...
  <div className="mb-16 lg:mb-0 xl:mt-16 md:space-y-16 space-y-10">
    ...
    <ul className="list mb-6 space-y-12">
      ...
      <i
        ...
        Explore a world of health solutions with our extensive range of medications. <br /> From trusted, well-known brands to specialized treatments
