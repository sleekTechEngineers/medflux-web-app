  ...
  return (
    ...
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Stay Updated on Our System
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Get the latest updates, features, and tips for using our innovative system. Subscribe now to stay informed!
      </p>
      <div>
        <input
          type="text"
        ...
        We respect your privacy and  committed  keeping your information safe. Rest assured, we won’t  share your details with third parties.Thanks for trusting 
        </p>
      </div>
    </div>
  );
